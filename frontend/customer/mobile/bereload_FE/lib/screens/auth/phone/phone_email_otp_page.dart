...
class PhoneEmailOtpPage extends StatefulWidget {
  final String email;

  const PhoneEmailOtpPage({
    super.key,
    required this.email,
  });

  @override
  State<PhoneEmailOtpPage> createState() => _PhoneEmailOtpPageState();
}

class _PhoneEmailOtpPageState extends State<PhoneEmailOtpPage> {
                          ...
                          onPressed: () {
                            if (_isValidOtp) {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      const DobPage(flow: AuthFlow.phone),
                                ),
                              );
                            }
                          },
