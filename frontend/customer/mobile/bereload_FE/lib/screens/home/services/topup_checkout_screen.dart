...
import './topup_payment_status.dart';
import 'dart:math';
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Purchased top-up redeem code will be sent to the email address you provide below.',
                      style: GoogleFonts.inter(
                        fontSize: 14,
                        color: Colors.grey[500],
                      ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          '€${(double.parse(widget.amount.replaceAll('€', '')) * quantity).toStringAsFixed(2)}',
                          style: GoogleFonts.inter(
                            fontSize: 16,
                            fontWeight: FontWeight.w500,
                            color: Colors.grey[900],
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          '€${(double.parse(widget.amount.replaceAll('€', '')) * quantity + 1.50 - 1.00).toStringAsFixed(2)}',
                          style: GoogleFonts.inter(
                            fontSize: 18,
                            fontWeight: FontWeight.w700,
                            color: Colors.grey[900],
            ...
            child: Container(
              ...
              child: TextButton(
                onPressed: () {
                  ...
                  List<String> topUpCodes = List.generate(quantity, (index) {
                  ...
                  OrdersSingleton().addOrder(
                    orderType: 'Mobile Top-up',
                    subType:
                        widget.isDataPlan ? 'Data Package' : 'Normal Top-up',
                    amount: totalAmount,
                    subTotal: subTotal,
                    status: 'Completed',
                    ...
                    paymentMethod: selectedPaymentMethod[0].toUpperCase() +
                        selectedPaymentMethod.substring(1),
                    reference: 'MTU${DateTime.now().millisecondsSinceEpoch}',
                    redeemCode: topUpCodes.join('|'),
                    quantity: quantity,
