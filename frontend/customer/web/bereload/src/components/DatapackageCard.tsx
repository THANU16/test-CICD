...
const DataPackageCard: React.FC<DataPackageCardProps> = ({
  ...
  return (
    <div className="relative h-auto bg-white shadow-md border-2 border-[#05E27E] rounded-xl overflow-hidden">
      ...
      <div className="absolute left-0 top-16 w-1 h-12 bg-[#09DB7C] rounded-r"></div>
      ...
      <div className="p-4 h-full flex flex-col">
        ...
        <div className="mt-7 mb-5 space-y-2">
          {features.map((feature, index) => (
            <div key={index} className="flex items-center gap-2">
              <FaCheck className="w-5 h-5 text-[#05E27E]" />
        ...
        <div className="mt-7 flex justify-between items-center">
          ...
          <button
            ...
            className="px-7 py-2.5 bg-primary text-gray-900 font-semibold text-sm rounded-lg hover:bg-primary/80 transition-opacity"
          >
            Get this plan
          </button>
        </div>
